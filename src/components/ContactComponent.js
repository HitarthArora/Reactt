...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email) {
        ...
        if(this.state.touched.firstname && firstname.length<3)
            errors.firstname = 'First Name >=3 characters';
        else if(this.state.touched.firstname && firstname.length>10)
            errors.firstname = 'First Name <=10 characters';

        if(this.state.touched.lastname && lastname.length<3)
            errors.lastname = 'Last Name >=3 characters';
        ...
        if(this.state.touched.email && email.split('').filter(x => x === '@').length !== 1)
            ErrorEvent.email= 'Email should contain one @ sign';
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <FormGroup row>
                            ...
                            <FormGroup row>
                                <Label htmlFor="feedback" md={2}>Last Name</Label>
                                <Col md={10}>
